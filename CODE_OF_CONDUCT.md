...
[GitHub private vulnerability reporting](https://github.com/ioplane/terraform-provider-nutanix/security/advisories/new).
...
from the [Contributor Covenant version 2.1 page][v2.1].
